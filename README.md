This is an example on how to coordinate concurrent log writes done by multiple threads. It uses dependency injection, logging, unit testing and adheres to SOLID principles.
